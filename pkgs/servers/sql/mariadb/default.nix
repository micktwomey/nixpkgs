...
, libaio, libevent, groff, jemalloc, perl, fixDarwinDylibNames, cctools, libtool, CoreServices
}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ cmake ncurses openssl zlib pcre libxml2 boost judy bison libevent ]
    ...
    ++ stdenv.lib.optionals stdenv.isDarwin [ perl fixDarwinDylibNames cctools libtool CoreServices ];
